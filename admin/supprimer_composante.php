<?php 
    ...
    if (isset($_SESSION['id_user'])) {
        ...
        if (isset($_GET['action']) && isset($_GET['id_comp'])) {
            $composante = htmlspecialchars($_GET['composante']);
    ...
    <?php
        $logo = "index.php";
        $nav = "composante";
        $title = "Suppression d'une composante";
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12" id="supprimer_show">
                <h5>Voulez vous supprimer la composante <?php echo $composante; ?> ?</h5>
                <h6><a href="?action=del&amp;id=<?php echo $id; ?>">Oui</a> ou <a href="liste_composante.php">Non</a></h6>
            </div>
        </div>
    </div>
...
<?php 
            ...
            if ($_GET['action']=='del') {
                ...
                $delete = $db->query("DELETE FROM composante WHERE id_comp='$id'");
