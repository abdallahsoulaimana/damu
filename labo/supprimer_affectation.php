<?php 
    ...
    if (isset($_SESSION['id_user'])) {
        ...
        if (isset($_GET['action']) && isset($_GET['id_affectation']) && $_GET['action'] == "delete") {
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12" id="supprimer_show">
                <h5>Voulez vous supprimer l'affectation du produit  <?php echo $nom_produit; ?> ?</h5>
                <h6><a href="?action=del&amp;id=<?php echo $id_affectation; ?>">Oui</a> ou <a href="liste_affectation.php">Non</a></h6>
            </div>
        </div>
    </div>
...
<?php 
            ...
            if ($_GET['action']=='del') {
                ...
                $delete = $db->query("DELETE FROM affectation WHERE id_affectation='$id'");
