    ...
    if (isset($_SESSION['id_user'])) {
        ...
        if (isset($_GET['search'])) {
            if (!empty($_GET['search'])) {
                ...
                $select_affectation = $db->prepare("SELECT a.*, DATE_FORMAT(dat_actuel, '%d/%m/%Y') AS date_actuel, p.nom_produit, c.nom_comp, u.nom, u.prenom FROM affectation a
                                                    ...
                                                    WHERE nom_produit LIKE '%".$search."%' OR nom_comp LIKE '%".$search."%' ORDER BY date_achat DESC");
        ...
        <div class="row">
            ...
            <h3>Liste des affectations</h3>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        ?>
                            <tr class="table table-light">
                                ...
                                <td style="width:200px;"><?php echo $data['nom_comp']; ?></td>
                                ...
                                <td>
                                    <a href="modifier_affectation.php?action=update&amp;id_affectation=<?php echo $data['id_affectation']; ?>">
                                    ...
                                    <a href="supprimer_affectation.php?action=delete&amp;id_affectation=<?php echo $data['id_affectation']; ?>&amp;nom_produit=<?php echo $data['nom_produit']; ?>">
                ...
                <div id="fiche_imprimer">
                    <a href="consultation_affectation.php">
