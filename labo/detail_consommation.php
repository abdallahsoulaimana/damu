<?php 
    ...
    if (isset($_SESSION['id_user'])) {
        ...
        if (isset($_GET['action'])) {
            ...
            $id_user_af = htmlspecialchars($_GET['id_user']);
            $nom_produit = htmlspecialchars($_GET['nom_produit']);
            $nom_comp = htmlspecialchars($_GET['nom_comp']);

            $select_produit_affecter = $db->query("SELECT * FROM affectation WHERE id_produit_affecter = '$id_produit' AND id_user_affecte='$id_user_af'");
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12" id="liste_show">
                <div id="login">
                    <div id="admin" style="width:70%;">
                        <h3>Toutes les affectations du produit <strong><?php echo $nom_produit; ?></strong> <br> sur la composante <strong><?php echo $nom_comp; ?></strong></h3>
                        <div class="table-responsive" id="liste_table">
                    <table class="table table-hover">
                        <thead>
                            <tr class="table table-success">
                                <th>#</th>
                                <th>Date et heure affectée</th>
                                <th style="width:200px;">Quantité affectée</th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php
