        ...
        <div class="row">
            ...
            <h3>Liste de tous les Fournisseurs</h3>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        ?>
                            <tr class="table table-light">
                                ...
                                <td>
                                    <a href="modifier_fournisseur.php?action=update&amp;id_fourni=<?php echo $data['id_fourni']; ?>">
                                    ...
                                    <a href="supprimer_fournisseur.php?action=delete&amp;id_fourni=<?php echo $data['id_fourni']; ?>&amp;nom_fournisseur=<?php echo $data['nom_fournisseur']; ?>">
                ...
                <div id="fiche_imprimer">
                    <a href="consultation_fournisseur.php">
