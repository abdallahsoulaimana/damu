<?php 
    ...
    if (isset($_SESSION['id_user'])) {
        ...
        $select = $db->prepare("SELECT *, DATE_FORMAT(date_cheque, '%d-%m-%Y') AS date_cheque FROM cheque ");
        $select ->execute();
    ?>
    <!DOCTYPE html>
    <html>
    ...
    <?php
        $logo = "index.php";
        $nav = 'cheque';
        $title = "Liste de tous les chèques"; 
        ...
        <div class="row">
            ...
            <h3>Liste de tous les chèques</h3>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        ?>
                            <tr class="table table-light">
                                <td><?php echo $i; ?></td>
                                <td><?php echo $data['num_cheque']; ?></td>
                                <td><?php echo $data['date_cheque']; ?></td>
                                <td><?php echo $data['libelle_cheque']; ?></td>
                                <td><?php echo $data['beneficiaire']; ?></td>
                                <td><?php echo $data['montant']; ?> KMF</td>
                                <td>
                                    <a href="modifier_cheque.php?action=update&amp;id_cheque=<?php echo $data['id_cheque']; ?>">
                                    ...
                                    <a href="supprimer_cheque.php?action=delete&amp;id_cheque=<?php echo $data['id_cheque']; ?>&amp;num_cheque=<?php echo $data['num_cheque']; ?>">
                ...
                <div id="fiche_imprimer">
                    <a href="consultation_cheque.php">
